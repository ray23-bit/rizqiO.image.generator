 class VideoPromptGenerator {
        ...
        this.container.innerHTML = `
            ...
            <div class="section">
                ...
                <div id="character-dialogue-section" class="dialogue-section">
                    <h3><i class="fas fa-comments"></i> Character Dialogue<br><small>(Dialog Karakter)</small></h3>
                    ...
                    <div id="character-3-dialogue" class="character-dialogue" style="display: none;">
                        <div class="input-group">
                            <label for="character-3-name">Character 3 Name<br><small>(Nama Karakter 3)</small></label>
                            <input type="text" id="character-3-name" placeholder="e.g., David, Anna">
                        </div>
                        <div class="input-group">
                            <label for="character-3-desc">Character 3 Description<br><small>(Deskripsi Karakter 3)</small></label>
                            <input type="text" id="character-3-desc" placeholder="e.g., police officer, wearing uniform">
                        </div>
                        <div class="input-group">
                            <label for="character-3-dialogue">Character 3 Dialogue<br><small>(Dialog Karakter 3)</small></label>
                            <textarea id="character-3-dialogue" rows="2" placeholder="What this character says..."></textarea>
                        </div>
                    </div>
                    ...
                    <div id="character-4-dialogue" class="character-dialogue" style="display: none;">
                        <div class="input-group">
                            <label for="character-4-name">Character 4 Name<br><small>(Nama Karakter 4)</small></label>
                            <input type="text" id="character-4-name" placeholder="e.g., Emily, Robert">
                        </div>
                        <div class="input-group">
                            <label for="character-4-desc">Character 4 Description<br><small>(Deskripsi Karakter 4)</small></label>
                            <input type="text" id="character-4-desc" placeholder="e.g., journalist, holding microphone">
                        </div>
                        <div class="input-group">
                            <label for="character-4-dialogue">Character 4 Dialogue<br><small>(Dialog Karakter 4)</small></label>
                            <textarea id="character-4-dialogue" rows="2" placeholder="What this character says..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    setupEventListeners() {
        ...
        // Dialog close button
        const dialogClose = document.getElementById('video-dialog-close');
        if (dialogClose) {
    ...
    setDefaults() {
        ...
        const defaults = {
            ...
            'video-characters': '1',
            'character-1-name': 'Detective',
            'character-1-desc': 'wearing trench coat and fedora',
            'character-1-dialogue': 'I\'ve seen things you people wouldn\'t believe...',
    ...
    generatePrompt() {
        ...
        const characterCount = parseInt(characters);
        let characterPrompt = '';
        
        for (let i = 1; i <= characterCount && i <= 4; i++) {
